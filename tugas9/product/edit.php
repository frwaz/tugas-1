...
$page_title = "Edit Produk - Toko Sederhana";
    ...
    <form action="db_action/update.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="category" name="category" required>
                <?php foreach (["Elektronik", "Pakaian", "Buku", "Rumah Tangga"] as $cat): ?>
        ...
        <div class="mb-3">
            ...
            <?php if (!empty($product['image'])): ?>
                <img src="../uploads/<?= htmlspecialchars($product['image']); ?>" alt="<?= htmlspecialchars($product['name']); ?>" width="100" class="mt-2 d-block">
            <?php endif; ?>
        </div>
        <div class="mb-3">
